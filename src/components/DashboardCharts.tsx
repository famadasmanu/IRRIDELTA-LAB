...
export default function DashboardCharts() {
 ...
 {/* Gráfico Financiero */}
 <div className="lg:col-span-2 bg-card p-6 rounded-2xl shadow-sm border border-bd-lines">
 <h3 className="text-lg font-bold text-tx-primary mb-4">Finanzas: Ingresos vs Egresos</h3>
 ...
 {/* Gráfico de Trabajos */}
 <div className="bg-card p-6 rounded-2xl shadow-sm border border-bd-lines flex-1">
 <h3 className="text-lg font-bold text-tx-primary mb-4">Estado de Trabajos</h3>
 ...
 <span className="text-3xl font-bold text-tx-primary ">{jobsData.reduce((a, b) => a + b.value, 0)}</span>
 <span className="text-xs text-tx-secondary">Total</span>
 </div>
 </div>
 <div className="flex justify-center gap-4 mt-2">
 {jobsData.map(j => (
 <div key={j.name} className="flex items-center gap-1.5 text-xs font-medium text-tx-secondary dark:text-tx-secondary">
 ...
 <h3 className="text-lg font-bold text-tx-primary ">Alertas de Stock</h3>
 </div>
 ...
 <p className="text-xs text-tx-secondary dark:text-tx-secondary">Min: {item.min} u.</p>
 </div>
 </div>
